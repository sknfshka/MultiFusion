...
//        connect( painter, SIGNAL( objectCreated() ), this, SLOT( onObjectCreated() ) );
        ...
        imageAction = objectMenu->addAction(  tr( "&Image" ) );
        //imageAction->setShortcut( tr( "Ctrl+G" ) );
        //imageAction->setIcon( QIcon( ":/main/images/object-group.png" ) );
        connect( imageAction, SIGNAL( triggered( bool ) ), this, SLOT( showImage()));
